export const API_BASE_URL = 'http://localhost:5000/api'; // Base URL for the backend API
...
export const MAX_URL_LENGTH = 2048; // Maximum length for URLs to be shortened
